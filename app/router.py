        ...
        try:
            ...
            if delay > 0:
                ...
                try:
                    ...
                    # Event set → someone else sent it (or we heard it on UDP)
                    self.log.info("Canceled (heard on UDP): %r", key[:120])
                    return
                ...
                if self.seen.seen(key):
                    self.log.info("Canceled (heard on UDP after timeout): %r", key[:120])
                    return
